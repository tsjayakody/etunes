<template>
  <default-layout>
    ...
    <artists-section id="artists" class="md:pt-12" />
    <workwithus-section id="about" class="md:pt-12" />
  </default-layout>
</template>
...
import FeaturedVideosSection from "@/Components/Sections/FeaturedVideosSections.vue";
